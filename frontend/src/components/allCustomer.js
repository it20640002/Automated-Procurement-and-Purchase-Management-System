...
export default class allCustomer extends Component {
    ...
    componentDidMount() {
        //execute the React code when the component is already placed
    ...
    //search bar
    handleSearchArea = (e) => {
        //get the changes and update the value
                ...
                >
                    ...
                    <tbody>
                        {this.state.customers.map(
                            (
                                customers,
                                index //to take an array of customer details
                            ) => (
