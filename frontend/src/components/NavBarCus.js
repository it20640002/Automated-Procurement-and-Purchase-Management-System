        ...
        return (
            <div>
                ...
                <div className="container-fluid">
                    <a className="navbar-brand" href="/Home" style={{fontSize:'30px'}}>PMS</a>
                    ...
                    <ul className="navbar-nav me-auto mb-2 mb-lg-0">
                        ...
                        &nbsp;
                        <li className="nav-item">
                        <a className="nav-link" aria-current="page" href="/addRes">Requisitions </a>
                        </li>
                        &nbsp;
                        <li className="nav-item">
                        <a className="nav-link" aria-current="page" href="/FeedbackHome">Approved Orders</a>
                        </li>
                        &nbsp;
