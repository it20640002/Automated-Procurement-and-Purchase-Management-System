...
export default class createCustomer extends Component{
  ...
  render(){
    return(
      <html>
      <body>
        <section style={{backgroundImage:`url('https://images.unsplash.com/photo-1567954970774-58d6aa6c50dc?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1932&q=80')`,
